...
const ReportsCCFunnel1: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Funnel 1 - Konverzní trychtýř CC</h1>
        ...
        <>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-700">
                    ...
                    Zkuste vybrat jiné časové období nebo importovat testovací data.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div key={stage.stage} className="bg-white rounded-lg shadow border border-gray-100 p-4 flex flex-col gap-3">
                    ...
                    {topReason ? (
                      <div className="bg-red-50 rounded-md p-2">
                        <p className="text-xs text-red-800 font-medium">Top důvod zamítnutí</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            {funnelChartData.length > 0 && (
              <div className="bg-white rounded-lg shadow p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Konverzní trychtýř</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={funnelChartData} layout="horizontal">
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="count" fill="#3B82F6" name="Počet leadů" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            )}
            ...
            {declineReasonsChartData.length > 0 && (
              <div className="bg-white rounded-lg shadow p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Důvody zamítnutí</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
            ...
            {timeInStagesChartData.length > 0 && (
              <div className="bg-white rounded-lg shadow p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Průměrný čas ve fázích (dny)</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={timeInStagesChartData}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Bar dataKey="days" fill="#10B981" name="Průměrný počet dnů" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            )}
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Průměrný čas (dny)</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Top důvody zamítnutí</th>
                  </tr>
                </thead>
          ...
          {stageNotes.length > 0 && (
            <div className="bg-white rounded-lg shadow mb-6">
              <div className="p-4 border-b border-gray-200 flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Nejnovější poznámky z fází</h2>
              </div>
          ...
          {reportData.declinedReasons && reportData.declinedReasons.length > 0 && (
            <div className="bg-white rounded-lg shadow">
              <div className="p-4 border-b border-gray-200">
                <h2 className="text-lg font-semibold text-gray-900">Celkový přehled důvodů zamítnutí</h2>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Důvod</th>
