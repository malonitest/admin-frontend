...
export default function TimeFunnelAmApprovedToTechnicianPage() {
  const now = new Date();
  ...
  const fetchRows = async () => {
    ...
    try {
      ...
      const response = await axiosClient.get<PaginatedResponse<TimeFunnelRow>>('/leads/timeFunnel/amApprovedToTechnician', {
        params: {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700">Od (Schválen AM)</label>
          <input
            type="date"
            value={dateFrom}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Do (Schválen AM)</label>
          <input
            type="date"
            value={dateTo}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Obchodník (kdo schválil AM)</label>
          <select
