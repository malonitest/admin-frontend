...
const ReportsCCFunnelTechnik: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Funnel Technik - Přehled kontroly vozidel</h1>
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
              <div className="flex items-center gap-2 text-blue-700 mb-1">
                ...
                <span className="text-sm">Celkem předáno</span>
              </div>
            ...
            <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
              <div className="flex items-center gap-2 text-purple-700 mb-1">
                ...
                <span className="text-sm">Průměrná doba</span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            {statusBreakdownChartData.length > 0 && (
              <div className="bg-white rounded-lg shadow p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Rozložení podle statusů</h3>
              ...
              <div className="bg-white rounded-lg shadow p-4">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={declineReasonsChartData} layout="vertical" margin={{ left: 150 }}>
                    ...
                    <Tooltip />
                    <Bar dataKey="count" fill="#EF4444" name="Počet" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            )}
          ...
          <div className="bg-white rounded-lg shadow mb-6 overflow-hidden">
            <div className="p-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Seznam leadů ({reportData.leads.length})</h2>
            </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Částka</th>
                  ...
                  {reportData.leads.map((lead, index) => (
                    <tr key={lead.leadId} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="px-4 py-3 text-right text-sm font-medium text-gray-900">
                        {lead.requestedAmount.toLocaleString('cs-CZ')} Kč
                      </td>
                      <td className="px-4 py-3">
